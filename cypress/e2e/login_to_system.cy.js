...
describe("login to CMA", () => {
  ...
  it.only("Should add a new always-on rule", () => {
    ...
    loginHelper.setRadioButtonState(loginHelper.LOCATORS.enablePolicyToggle,true)
    ...
    loginHelper.deleteRowByIndex(2);
    loginHelper.setRadioButtonState(loginHelper.LOCATORS.enablePolicyToggle,false)
    loginHelper.assertSavedSuccessfully();
  });
